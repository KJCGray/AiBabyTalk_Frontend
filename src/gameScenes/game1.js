...
export default {
  ...
  create: function () {
    ...
    // 根據畫面動態設置柵欄及其他物件
    this.add.sprite(screenWidth * 0.02, screenHeight * 0.7, "bush");
    this.add.sprite(screenWidth * 0.119, screenHeight * 0.7, "bush");
    this.add.sprite(screenWidth * 0.218, screenHeight * 0.7, "bush").setDepth(10);
    this.add.sprite(screenWidth * 0.218, screenHeight * 0.595, "bush").setDepth(5);
    this.add.sprite(screenWidth * 0.218, screenHeight * 0.49, "bush").setDepth(1);
    this.add.sprite(screenWidth * 0.318, screenHeight * 0.49, "bush");
    this.add.sprite(screenWidth * 0.418, screenHeight * 0.49, "bush");
    this.add.sprite(screenWidth * 0.518, screenHeight * 0.49, "bush");
    this.add.sprite(screenWidth * 0.618, screenHeight * 0.49, "bush");

    this.add.sprite(screenWidth * 0.47, screenHeight * 0.9, "bush").setDepth(10);
    this.add.sprite(screenWidth * 0.47, screenHeight * 0.795, "bush").setDepth(5);
    this.add.sprite(screenWidth * 0.569, screenHeight * 0.795, "bush").setDepth(1);
    this.add.sprite(screenWidth * 0.668, screenHeight * 0.795, "bush");
    ...
    if (localProgress === 0) {
      this.door = this.add.sprite(screenWidth * 0.6, screenHeight * 0.65, "door").setDepth(10);
      this.carrot = this.add.sprite(screenWidth * 0.7, screenHeight * 0.65, "carrot").setDepth(10);
